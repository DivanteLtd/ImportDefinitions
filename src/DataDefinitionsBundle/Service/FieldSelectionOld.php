...
class FieldSelection
{
     ...
     * @throws \Exception
     */
    public function getClassDefinition(DataObject\ClassDefinition $class): iterable
    {
     ...
     * @return ToColumn
     */
    protected function getFieldConfiguration(DataObject\ClassDefinition\Data $field, ?string $typeName): ToColumn
    {
        $toColumn = new ToColumn();
